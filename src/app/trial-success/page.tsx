        ...
        >
            <div className="w-full max-w-md animate-fade-in">
                <div className="bg-white rounded-2xl shadow-2xl overflow-hidden p-8 text-center">
                    ...
                    {/* WhatsApp Opt-in */}
                    <a
                        href="https://wa.me/918690211190?text=Hi%2C%20I%20just%20registered%20for%20free%20trial%20yoga%20class%20with%20Renu%20Tayal!%20Please%20send%20me%20my%20join%20link.%20%F0%9F%99%8F"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center gap-2 w-full py-3.5 rounded-xl font-semibold text-white text-base mb-3 transition-all duration-200 hover:brightness-110 hover:shadow-lg active:scale-[0.98]"
                    ...
                    >
                        ...
                        ✅ Click here to activate WhatsApp reminders
                    </a>
                    <p className="text-xs text-gray-500 mb-6 leading-relaxed">
                        Send this message to receive your personal Zoom link and daily session reminders on WhatsApp
                    </p>
